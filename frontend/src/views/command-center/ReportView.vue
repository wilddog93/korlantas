...
const dataBoardReport = [
  {
    id: 1,
    images: new URL('/src/assets/images/icon-report/analisis-lokasi-laka.png', import.meta.url).href,
  ...
  {
    id: 4,
    images: new URL('/src/assets/images/icon-report/statistik-waktu.png', import.meta.url).href,
    title: "Statistik Waktu Laka"
  },
  {
    id: 5,
    images: new URL("/src/assets/images/icon-report/analisis-faktor-utama.png", import.meta.url).href,
    title: "Analisis Faktor Utama Laka"
  },
  {
    id: 6,
    images: new URL("/src/assets/images/icon-report/analisis-rata-kerugian.png", import.meta.url).href,
    title: "Analisis Rata-Rata Kerugian"
  },
  {
    id: 7,
    images: new URL("/src/assets/images/icon-report/statistik-prilaku-pengemudi.png", import.meta.url).href,
    title: "Statistik Prilaku Pengemudi"
  },
  {
    id: 8,
    images: new URL("/src/assets/images/icon-report/statistik-jenis-lokasi-kendaraan.png", import.meta.url).href,
    title: "Statistik Jenis Kendaraan"
  },
  {
    id: 9,
    images: new URL("/src/assets/images/icon-report/statistik-jenis-laka.png", import.meta.url).href,
  ...
  {
    id: 11,
    images: new URL("/src/assets/images/icon-report/statistik-jumlah-korban.png", import.meta.url).href,
