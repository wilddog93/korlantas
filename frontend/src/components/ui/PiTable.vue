    ...
    <div class="relative overflow-x-auto">
      <div  class="w-full">
          ...
          <table class="text-sm table-auto border-collapse w-full">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b border-slate-200">
              <tr>
                ...
                <th
                  v-for="(column, columnKey) in computedColumns"
                  :key="columnKey"
                  :aria-controls="`col-${columnKey+1}`"
                  :style="{ width: `${width[columnKey + 1]}px`}"
        ...
        <div class="w-full -mt-11" :style="{ height: `${calculatedHeight}px`}">
          <!-- Empty state -->
          <div v-if="!pagination?.total && !loading" class="absolute flex justify-center items-center bottom-0 top-0 w-full">
    ...
    <div ref="footer" class="grid grid-cols-3 gap-5 py-3 items-center px-6 border-t border-gray-500/20">
      <div v-if="pagination" class="flex items-center space-x-3">
        ...
        <div class="flex items-center space-x-2">
          <select v-model="pagination.limit" class="text-gray-500 font-light underline border-none cursor-pointer outline-none">
      ...
      <div v-if="pagination && pagination.total" class="flex items-center space-x-2 justify-end">
        <span>Page:</span>
        <div class="flex items-center space-x-2">
          <select v-model="pagination.page" class="text-gray-500 font-light underline border-none cursor-pointer outline-none">
