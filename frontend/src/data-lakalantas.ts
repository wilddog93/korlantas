export const main = [
  {
    ...
    ringan: [
      ...
      {
        datetime: "2024-06-17T15:03:52.270Z",
        total: 15,
      },
      {
        datetime: "2024-07-17T15:03:52.270Z",
        total: 16,
      },
      {
        datetime: "2024-08-17T15:03:52.270Z",
        total: 17,
      },
    ],
    berat: [
...
export const announces = [
  {
    id: 1,
    description:
      "Perhatian pengguna jalan tol, cuaca buruk diperkirakan dalam beberapa bulan",
    datetime: "2024-01-17T15:03:52.270Z",
  },
  {
    id: 2,
    description:
      "Informasi penting. Besok akan dila-kukan pemeliharaan jalan di KM 40",
    datetime: "2024-02-17T15:03:52.270Z",
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    description:
      "Penting! Jalur reguler di KM 31 ditutup untuk sementara waktu.",
    datetime: "2024-04-17T15:03:52.270Z",
  },
  {
    id: 5,
  ...
  data: [
    {
      id: 1,
      kode_lantas: "GTX001",
      petugas: "BRIPKA Indra",
      lokasi: "Jagorawi",
      ruas_jalan: "A",
      kilometer: Math.floor(Math.random() * 100),
      jenis: "Depan - Belakang",
      kategori: "3 LR 4M",
      waktu_kecelakaan: "01/01/2023",
    },
    {
      id: 2,
      kode_lantas: "GTX002",
      petugas: "BRIPKA Jegel",
      lokasi: "Bitung",
      ruas_jalan: "A",
      kilometer: Math.floor(Math.random() * 100),
      jenis: "Depan - Belakang",
